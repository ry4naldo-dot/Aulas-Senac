create database desafio_MODeEX
...
UPDATE jogos_que_mais_joguei SET duracao = '8 Horas' WHERE nome = 'Halo:CE';

update jogos_que_mais_joguei set duracao = '10 Horas' where nome = 'Halo Reach';

DELETE FROM jogos_que_mais_joguei WHERE nome = 'Stardew Valley';
